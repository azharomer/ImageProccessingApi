...
describe('2- check resize End Point', () => {
    ...
    it('should get status 400 if any param missed ', () => {
        (0, supertest_1.default)(index_1.default).get('/api/images/resize?width=100&height=200').expect(400);
    });
    it('should get status 400 if sent width or height negative ', () => {
    ...
    it('should get status 400 if send all params correct but image not exist in folder ', () => {
        (0, supertest_1.default)(index_1.default)
